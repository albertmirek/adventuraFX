...
/*******************************************************************************
 * {@code ScenMan_TLoc_Icebox} instance serves as
 ...
 * @version 2018-Winter
 */
public   class ScenMan_TLoc_Icebox
...
//\CC== CLASS CONSTANTS (CONSTANT CLASS/STATIC ATTRIBUTES/FIELDS) ==============
    ...
    private static final ScenMan_TLoc_Icebox MANAGER =
                                             new ScenMan_TLoc_Icebox();
...
//\CF== CLASS (STATIC) FACTORY METHODS =========================================
     ...
     */
    public static ScenMan_TLoc_Icebox getInstance()
    {
        return MANAGER;
    }
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     * The order of the subsequently added scenarios is not decisive.
      */
    private ScenMan_TLoc_Icebox()
    {
        super(InitProperties.getInstance().factoryClass);

        List<ScenarioStep[]> list = ScenarioStepsLoc.getScenarioSteps();
