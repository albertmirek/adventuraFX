...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    AButtonPane(IMyGUI gui, String title)
    {
        this.gui = gui;
...
//    @Override
     ...
     */
//    @Override
    abstract public void initializeForGame(IGameG game);
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
     ...
     */
    void initializationForGame(IGameG game, String commandName)
    {
        this.game        = game;
    ...
    public void actualize()
    {
        ...
        for (INamed iNamed : objects) {
            ...
            Button button = (iNamed instanceof IItemG)
                          ? new Button("", ((IItemG)iNamed).getPicture())
                          : new Button(name);
