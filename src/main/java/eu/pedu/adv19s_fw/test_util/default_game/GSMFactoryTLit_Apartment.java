 ...
 * @version 2018-Winter
 */
public   class GSMFactoryTLit_Apartment
...
//\CI== CLASS (STATIC) INITIALIZER (CLASS CONSTRUCTOR) =========================
    ...
    static {
        new InitProperties("Implicitní textová hra - Služební byt s ledničkou",
                           GSMFactoryTLit_Apartment.class);
    }
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    public GSMFactoryTLit_Apartment()
    {
    }
...
//\MM== MAIN METHOD ============================================================
    ...
    {
        GSMFactoryTLit_Apartment factory = new GSMFactoryTLit_Apartment();
