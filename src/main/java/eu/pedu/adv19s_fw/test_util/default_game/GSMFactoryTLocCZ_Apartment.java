...
import eu.pedu.adv19s_fw.test_util.default_game.smanagers.ScenMan_TLit_Icebox;
...
/*******************************************************************************
 * {@code GSMFactoryTLocCZ_Apartment} instances represent the factory objects
 ...
 * @version 2018-Winter
 */
public   class GSMFactoryTLocCZ_Apartment
...
//        new InitProperties(
//            "Implicitní textová hra - Služební byt s ledničkou",
//            GSMFactoryTLocCZ_Apartment.class);
//    }
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    public GSMFactoryTLocCZ_Apartment()
    {
    }
...
//\IG== INSTANCE GETTERS AND SETTERS ===========================================
     ...
     */
    @Override
    public Class<GSMFactoryTLocCZ_Apartment> getFactoryClass()
    {
        return GSMFactoryTLocCZ_Apartment.class;
    }
     ...
     */
    @Override
    public ScenMan_TLit_Icebox getScenarioManager()
    {
        return ScenMan_TLit_Icebox.getInstance();
    }
...
//\MM== MAIN METHOD ============================================================
    ...
    {
        GSMFactoryTLocCZ_Apartment factory = new GSMFactoryTLocCZ_Apartment();
