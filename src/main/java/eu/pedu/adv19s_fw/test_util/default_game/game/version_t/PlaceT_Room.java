...
/*******************************************************************************
//%L+ CZ
 * Instance třídy {@code PlaceT_Room} představují jednotlivé prostory hry;
 * v této hře jsou těmito prostory místnosti bytu a lednička.
//%Lx EN
 * The {@code PlaceT_Room} instances represent the places in the game;
