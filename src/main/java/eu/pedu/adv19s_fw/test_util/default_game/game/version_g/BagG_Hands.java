 ...
 * @version 2018-Winter
 */
public    class BagG_Hands
        extends AItemContainerG
     implements IBagG, IMyBag<ItemG>
{
//\CC== CLASS CONSTANTS (CONSTANT CLASS/STATIC ATTRIBUTES/FIELDS) ==============
    ...
    private static final BagG_Hands SINGLETON = new BagG_Hands();
...
//\CF== CLASS (STATIC) FACTORY METHODS =========================================
     ...
     */
    public static BagG_Hands getInstance()
    {
        return SINGLETON;
    }
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
     ...
     */
    @Override
    public boolean tryAddItem(ItemG item)
    {
