...
/*******************************************************************************
 * {@code ScenMan_TLit_Icebox} instance serves as
 ...
 * @version 2018-Winter
 */
public   class ScenMan_GLit_Icebox
...
//\CC== CLASS CONSTANTS (CONSTANT CLASS/STATIC ATTRIBUTES/FIELDS) ==============
    ...
    private static final InitProperties INIT_PROPERTIES =
                                         InitProperties.getInstance();

    /** The only instance of this class.
     *  It manages all scenarios of the associated game. */
    private static final ScenMan_GLit_Icebox MANAGER;
...
//\CI== CLASS (STATIC) INITIALIZER (CLASS CONSTRUCTOR) =========================
    ...
    static {
        MANAGER = new ScenMan_GLit_Icebox();
    }
...
//\CF== CLASS (STATIC) FACTORY METHODS =========================================
     ...
     */
    public static AScenarioManagerG getInstance()
    {
        return MANAGER;
    }
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    private ScenMan_GLit_Icebox()
    {
        super((Class)INIT_PROPERTIES.factoryClass);

        List<ScenarioStep[]> list = ScenarioStepsLit.getScenarioSteps();
