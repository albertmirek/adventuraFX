...
import eu.pedu.adv19s_fw.test_util.default_game.smanagers.ScenMan_TCon_Icebox;
 ...
 * @version 2018-Winter
 */
public   class GSMFactoryTCon_Apartment
...
//\CI== CLASS (STATIC) INITIALIZER (CLASS CONSTRUCTOR) =========================
    ...
    static {
        new InitProperties("Implicitní textová hra - Služební byt s ledničkou",
                           GSMFactoryTCon_Apartment.class);
    }
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    public GSMFactoryTCon_Apartment()
    {
    }
...
//\IG== INSTANCE GETTERS AND SETTERS ===========================================
     ...
     */
    @Override
    public Class<GSMFactoryTCon_Apartment> getFactoryClass()
    {
        return GSMFactoryTCon_Apartment.class;
    }
...
//
    ...
    {
        return ScenMan_TCon_Icebox.getInstance();
    }
...
//\MM== MAIN METHOD ============================================================
    ...
    {
        GSMFactoryTCon_Apartment factory = new GSMFactoryTCon_Apartment();
