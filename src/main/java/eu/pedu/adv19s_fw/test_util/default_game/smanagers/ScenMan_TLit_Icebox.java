 ...
 * @version 2018-Winter
 */
public   class ScenMan_TLit_Icebox
...
//\CC== CLASS CONSTANTS (CONSTANT CLASS/STATIC ATTRIBUTES/FIELDS) ==============
    ...
    private static final ScenMan_TLit_Icebox MANAGER =
                                             new ScenMan_TLit_Icebox();
...
//\CF== CLASS (STATIC) FACTORY METHODS =========================================
     ...
     */
    public static ScenMan_TLit_Icebox getInstance()
    {
        return MANAGER;
    }
...
//\II== INSTANCE INITIALIZERS (CONSTRUCTORS) ===================================
     ...
     */
    private ScenMan_TLit_Icebox()
    {
        super(GSMFactoryTLit_Apartment.class);
