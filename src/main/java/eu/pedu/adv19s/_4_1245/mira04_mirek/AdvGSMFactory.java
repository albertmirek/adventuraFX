...
import eu.pedu.adv19s._4_1245.mira04_mirek.game.AdvScenarioManager;
 ...
 * @version 2018-Winter
 */
public   class AdvGSMFactory
    implements IGSMFactory, IAuthorAM
{
...
//\IG== INSTANCE GETTERS AND SETTERS ===========================================
   ...
   {
        return AdvScenarioManager.getInstance();
   }
     ...
     */
    @Override
    public MirSpaceGame getGame()
    {
        return MirSpaceGame.getInstance();
    }
